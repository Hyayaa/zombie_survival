...
describe("city bridge network",()=>{
  ...
  it("uses seven tile bridges with eight tile approaches",()=>expect(createBridgePlans().every((bridge)=>bridge.widthTiles===7&&bridge.approachLengthTiles===8)).toBe(true));
