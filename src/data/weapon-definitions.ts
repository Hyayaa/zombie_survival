...
export const WEAPON_DEFINITIONS: Record<WeaponId, WeaponDefinition> = {
  knife: { id: "knife", name: "식칼", kind: "melee", damage: 24, range: 28, arcRadians: 0.9, cooldownMs: 330, noise: 15, knockback: 8, maxTargets: 1, inventoryFootprint:{width:2,height:2} },
  bat: { id: "bat", name: "야구방망이", kind: "melee", damage: 20, range: 38, arcRadians: 1.45, cooldownMs: 680, noise: 24, knockback: 28, maxTargets: 4, inventoryFootprint:{width:2,height:4} },
  pistol: { id: "pistol", name: "권총", kind: "ranged", damage: 34, range: 260, arcRadians: 0, cooldownMs: 260, noise: 90, knockback: 12, maxTargets: 1, magazineSize: 8, reloadMs: 1_050, ammoItemId: "pistol_ammo", fireMode: "semi", pelletCount: 1, spreadRadians: 0, inventoryFootprint:{width:2,height:2} },
  ...
  shotgun: { id: "shotgun", name: "산탄총", kind: "ranged", damage: 13, range: 175, arcRadians: 0, cooldownMs: 720, noise: 120, knockback: 19, maxTargets: 1, magazineSize: 6, reloadMs: 1_650, ammoItemId: "shotgun_shell", fireMode: "semi", pelletCount: 6, spreadRadians: 0.3, inventoryFootprint:{width:2,height:4} },
