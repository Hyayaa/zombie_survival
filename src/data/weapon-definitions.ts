...
export const WEAPON_DEFINITIONS: Record<WeaponId, WeaponDefinition> = {
  ...
  hunting_rifle: { id: "hunting_rifle", name: "사냥용 소총", kind: "ranged", damage: 68, range: 430, arcRadians: 0, cooldownMs: 920, noise: 135, knockback: 22, maxTargets: 1, magazineSize: 5, reloadMs: 1_850, ammoItemId: "rifle_ammo", fireMode: "semi", pelletCount: 1, spreadRadians: 0.006, projectileSpeed: 1600, projectileRadius: 1, projectileVisualLength: 10, projectileVisualWidth: 2, movingSpreadRadians: 0.04, runningSpreadRadians: 0.08, shotBloomRadians: 0.055, maximumBloomRadians: 0.13, bloomRecoveryRadiansPerSecond: 0.11, inventoryFootprint:{width:4,height:1} },
};
