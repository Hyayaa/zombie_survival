import { normalizeInventoryFootprint, type InventoryFootprint } from "./item-definitions";
...
const WEAPON_SOURCES: Record<WeaponId, WeaponDefinition> = {
...
export const WEAPON_DEFINITIONS: Record<WeaponId, WeaponDefinition> = Object.fromEntries(
  Object.values(WEAPON_SOURCES).map((weapon) => [weapon.id, { ...weapon, inventoryFootprint: normalizeInventoryFootprint(weapon.inventoryFootprint) }]),
