...
export const ZOMBIE_DEFINITIONS: Record<ZombieKind, ZombieDefinition> = {
  walker: {
    kind: "walker", name: "배회자", health: 48, speed: 27, sightRadius: 104, hearingMultiplier: 1,
  ...
  runner: {
    kind: "runner", name: "질주자", health: 28, speed: 49, sightRadius: 122, hearingMultiplier: 1.35,
