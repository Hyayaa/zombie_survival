...
export const MELEE_ATTACK_DEFINITIONS: Record<MeleeWeaponId, Record<MeleeAttackMode, MeleeAttackDefinition>> = {
  knife: {
    stab: { mode: "stab", geometry: "capsule", damage: 25, postureDamage: 18, staminaCost: 8, range: 13, width: 6, arcRadians: 0, maxTargets: 1, knockback: 1, windupMs: 55, activeMs: 70, recoveryMs: 180, movementMultiplier: 0.8, turnSpeedRadiansPerSecond: 4.8, hitStopMs: 22 },
    swing: { mode: "swing", geometry: "arc", damage: 19, postureDamage: 24, staminaCost: 13, range: 14, width: 0, arcRadians: Math.PI * 0.5, maxTargets: 2, knockback: 4, windupMs: 95, activeMs: 105, recoveryMs: 230, movementMultiplier: 0.55, turnSpeedRadiansPerSecond: 2.8, hitStopMs: 31 },
