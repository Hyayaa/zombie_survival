...
import { createPlacedSegment, createPlacedStructure, getPlacedStructureCenter, normalizePlacedStructure, type PlacedStructureState, type SavedStructureState } from "../entities/placed-structure";
