export type CameraFeedbackEvent="melee-swing"|"melee-hit"|"melee-stab-miss"|"melee-stab-hit"|"melee-swing-miss"|"melee-swing-hit"|"melee-heavy-miss"|"melee-heavy-hit"|"posture-break"|"pistol-shot"|"smg-shot"|"shotgun-shot"|"rifle-shot"|"player-hit";
...
export const CAMERA_SHAKE_PROFILES:Record<CameraFeedbackEvent,CameraShakeProfile>={
  ...
  "melee-stab-miss":{durationMs:45,intensity:0.0008,cooldownMs:25,priority:1},"melee-stab-hit":{durationMs:70,intensity:0.0018,cooldownMs:30,priority:2},
  "melee-swing-miss":{durationMs:72,intensity:0.0014,cooldownMs:35,priority:1},"melee-swing-hit":{durationMs:105,intensity:0.003,cooldownMs:45,priority:3},
  "melee-heavy-miss":{durationMs:105,intensity:0.0023,cooldownMs:50,priority:2},"melee-heavy-hit":{durationMs:145,intensity:0.0052,cooldownMs:65,priority:4},
  "posture-break":{durationMs:155,intensity:0.0062,cooldownMs:70,priority:5},
